...
- **Micro-steps** _(UI Borders, Hover states):_ Shift L by 5% to 8% from base.
- **Macro-steps** _(Popups, Active Selections):_ Shift L by 12% to 15% from base.
...
_Builds 4 levels above a 7% base. Uses micro-steps (6%) for subtle UI changes and macro-steps (8%) for heavy elevation._
...
_Builds 2 levels below and 2 above using 8% intervals. Keeps color strictly within the "pigment" zone (39%–71%)._
...
_Drops 4 levels from 85% landing perfectly in the muted 40–50% range using a uniform 10% subtraction step._
